...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 539.0, 549.0, 29.5, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.0, 51.0, 46.0, 20.0 ],
					"text" : "s #0lb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 485.5, 549.0, 42.0, 20.0 ],
					"text" : "route id"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 464.0, 166.0, 29.5, 20.0 ],
					"text" : "!= 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 464.0, 200.5, 29.5, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 781.0, 139.0, 29.5, 20.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 781.0, 23.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "Mapped object id",
					"id" : "obj-11",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 485.5, 593.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 539.0, 85.0, 30.0, 20.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 539.0, 117.0, 85.0, 20.0 ],
					"text" : "ignoreclick $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 152.0, 112.0, 35.0, 20.0 ],
									"text" : "* 0.01"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 112.0, 112.0, 35.0, 20.0 ],
									"text" : "* 0.01"
								}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 388.0, 162.0, 473.5, 162.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 495.0, 513.5, 462.0, 513.5 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 3 ],
					"midpoints" : [ 790.5, 421.0, 398.5, 421.0 ],
					"order" : 1,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 801.0, 255.5, 495.0, 255.5 ],
					"order" : 0,
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 801.0, 256.0, 388.0, 256.0 ],
					"order" : 1,
					"source" : [ "obj-22", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 790.5, 539.5, 462.0, 539.5 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 548.5, 580.5, 495.0, 580.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 0 ],
					"midpoints" : [ 388.0, 238.0, 548.5, 238.0 ],
					"order" : 0,
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 349.0, 162.0, 473.5, 162.0 ],
					"order" : 0,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 462.0, 460.5, 495.0, 460.5 ],
					"order" : 0,
					"source" : [ "obj-42", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Max for Live Devices/EnvelopeShare Project/media",
				"patcherrelativepath" : "../../../../../../../../../Documents/Max 8/Max for Live Devices/EnvelopeShare Project/media",
				"type" : "svg",
				"implicit" : 1
			}
 ],
